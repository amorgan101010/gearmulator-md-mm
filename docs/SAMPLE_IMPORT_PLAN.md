...
(repo `/Users/jacobmandell/Desktop/5300/gearmulator-md-mm`, remote `fork` =
...
- Headless integration: extend `sdsFirmwareTest.cpp` or write `sampleImportFirmwareTest.cpp`: encode a known tone,
  ...
  Firmware images: `GEARMULATOR_MD_FIRMWARE_BIN=/Users/jacobmandell/Desktop/5300/roms/elektron_sps1-1uw_os1.63.bin`.
...
- Regression: `mdProjectStateRestoreTest` (needs `GEARMULATOR_MD_FIRMWARE_BIN`, `GEARMULATOR_MM_FIRMWARE_BIN`,
  optional `GEARMULATOR_MD_ALT_FIRMWARE_BIN=/Users/jacobmandell/Desktop/5300/roms/alt/elektron_sps1-1uw_os_x13.bin`),
